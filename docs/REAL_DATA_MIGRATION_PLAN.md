...
- 当前 `engine_core` 代码验证对象为 `c9aeb65be0496c82fda561de291865d2e1830aed`；其后仅有证据文档提交，未修改 `src/` 或 `tests/`。本地与 `cobra-ion` 对该代码对象均为 `300 passed`、`compileall` PASS，工作树干净。远端复验使用 Python 3.12.3、`TZ=Asia/Shanghai`、`PYTHONHASHSEED=0`。
