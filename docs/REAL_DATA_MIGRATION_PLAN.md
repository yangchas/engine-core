...
- 当前 `engine_core` 集成分支为 `codex/feature-session-engine-integration`，commit `eb39f5e`；本地与 `cobra-ion` 同提交均为 `299 passed`、`compileall` PASS，工作树干净。远端复验使用 Python 3.12.3、`TZ=Asia/Shanghai`、`PYTHONHASHSEED=0`。
