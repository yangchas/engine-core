...
commit            = fa3b7e3d70dd22e689d95970a0f24981c15b74a9
...
```text
python -m pytest -q       = 299 passed in 1.41s
python -m compileall -q src tests = PASS
```

The local run on the same commit also produced `299 passed in 0.86s`,
