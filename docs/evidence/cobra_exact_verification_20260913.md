...
commit            = c6f027aacffaf900aeb548d03e871e5c17e22460
...
```text
python -m pytest -q       = 299 passed in 1.47s
python -m compileall -q src tests = PASS
```

The local run on the same commit also produced `299 passed in 0.87s`,
