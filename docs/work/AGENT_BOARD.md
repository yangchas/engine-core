...
|---|---|---|---|---|---|
| TASK-007 Offline canonical replay / auction facts | replay-investigator | REVIEW | `codex/task-offline-canonical-auction-facts` | current development worktree | pure Rabbit-primary canonical batch to replay/facts seam; 666 tests pass; no production source or write path |
