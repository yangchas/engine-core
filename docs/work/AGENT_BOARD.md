...
|---|---|---|---|---|---|
| TASK-007 Offline canonical replay / auction facts | replay-investigator | READY | not started | no worktree | pure Core/offline facts only; no production source or write path |
