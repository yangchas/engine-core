...
- [VERIFIED] 2026-09-16 12:20 CST scheduled a new exact-build normal-origin Core morning shadow for 2026-09-17. The isolated runner (PID 519924 at scheduling) uses `/home/exedev/validation/engine-core-0421726`, explicit build id `0421726`, a real BaoStock calendar probe, and bounded symbols `000001,000002,600519`; output is write-once under `/home/exedev/validation/live-morning-shadow-20260917-0915`. Production services remain owners and no Rabbit/ACK/Redis/TD/effect path is changed. See `docs/evidence/scheduled_live_morning_shadow_20260917.md`.
