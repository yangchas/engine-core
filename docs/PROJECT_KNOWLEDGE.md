...
- [VERIFIED] 2026-09-14 离线验证基线（代码提交 `612a818` 后的文档修订）：当前本地收集为 `397` 个离线用例；代码等价的 Cobra-ion 归档 `81e0dd3` 已在 Python 3.12.3 通过 `397 passed` 与 `compileall`。此前 `322/393` 等数字保留为历史提交证据，不代表当前测试总数；在线 Redis/TD/生产替代验收仍须独立证据。
